...
class OpenAiCompatibleProtocol : ModelProtocol {
    ...
    private fun makeStreamRequest(
        ...
        val startedIndices = ConcurrentHashMap.newKeySet<Int>()   // 跟踪已通知 onToolCallStart 的索引
...
object ExtendedCallbacks {
    fun ModelStreamCallback.invokeOnComplete(text: String) {}
    fun ModelStreamCallback.invokeOnError(error: String) {}
}
